 ...
 * drift check, the pre-commit hook and CI for every future edit to a tree of three routes. The
...
const routeTree = rootRoute.addChildren([logRoute, sessionsRoute, sessionDetailRoute]);
