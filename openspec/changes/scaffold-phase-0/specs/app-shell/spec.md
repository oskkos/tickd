...
worker, and the icon set required for a home-screen install. Installability SHALL hold from this change
...
#### Scenario: Layout is verified on the trial device

- **WHEN** the app is opened on the Galaxy S26 Ultra
- **THEN** primary actions fall within the lower third of the viewport
